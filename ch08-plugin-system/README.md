...
> **上一章**我们解析了 LLM 集成层，理解了 Route 系统如何通过 Protocol、Endpoint、Auth、Framing 四个正交维度支持 30+ 提供商。本章将介绍插件系统——它是 Opencode 可扩展性的核心，让第三方开发者能注入自定义 Agent、Provider、工具和命令。
...
插件系统是 Opencode 可扩展性的基石，它将核心系统的稳定性和第三方扩展的灵活性有机地结合在一起。下一章将深入讲解权限与安全系统，看看 Opencode 如何在"让 Agent 高效工作"和"防止危险操作"之间取得平衡。